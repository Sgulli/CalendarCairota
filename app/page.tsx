export default function Home() {
  return (
    <div className="bg-white min-h-screen">
      <div className="mx-auto max-w-7xl py-24 sm:px-8 sm:py-32 lg:px-8">
        <div className="relative isolate overflow-hidden bg-red-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Calendario Cairota.
              <br />
              Scopri quanti anni hai secondo il calendario Cairota!
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Inserisci la tua età e ti verrà calcolato il tuo anno secondo il
              calendario Cairota.
            </p>
